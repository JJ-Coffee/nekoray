...
go build -v -o $DEST -trimpath -ldflags "-w -s -X $neko_common.Version_neko=$version_standalone" -tags "with_clash_api,with_dhcp,with_gvisor,with_quic,with_wireguard,with_utls,with_ech,with_reality_server,with_grpc"
popd
